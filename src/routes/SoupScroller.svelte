<script>
  ...
  let soups = [
    ...
    { 
      ...
      submitter: "Emi",
      title: "Veggie Soba",
      paragraphs: ["An quick and easy go to for when I want something to warm me up, stat.", "Toss some soba noodles in a dashi base with a variety of cooked veggies. My favorites include mushrooms, simmered squash, and yams."],
